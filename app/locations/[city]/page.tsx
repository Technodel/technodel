...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://technodel.net/locations/${city}` },
    openGraph: {
      title,
      description,
      url: `https://technodel.net/locations/${city}`,
      siteName: "Technodel",
      type: "website",
      locale: "en_US",
    },
  ...
  const localBusinessSchema = {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Gaming PCs", url: "https://technodel.net/shop/gaming" } },
      ],
    },
  };
